#!/usr/bin/env python3
"""Build 4: Import historic Wafi invoices (batch history) from audit/out CSV (Paid rows, 2025+)."""
...
def main():
    ...
    ap.add_argument("--limit", type=int, default=0, help="0 means all matching rows")
    ap.add_argument("--min-year", type=int, default=2025)
    args = ap.parse_args()
    limit = args.limit if args.limit > 0 else None
    invoices = load_invoices(min_year=args.min_year, limit=limit)

...
import { derivedActiveStatusLabel } from './employeeActive';
            ...
            {tab === 'personal' && (<>
                ...
                {!isEditing && <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                    <Card><STitle>Employment</STitle>
                        {[['Employee Code', emp.id], ['ASIL BU', normalizeAsilBu(emp.bu) || emp.bu], ['Client', emp.client], ['Client BU', emp.clientBU], ['Department', emp.dept], ['Designation', emp.designation], ['Location', emp.location + ', ' + (emp.province || '')], ['Date of Joining', emp.doj], ['Last Working Day', emp.lastWorkingDay || '—'], ['Status', derivedActiveStatusLabel(emp)]].map(([l, v]) => <Row key={l} label={l} value={v || '—'} />)}

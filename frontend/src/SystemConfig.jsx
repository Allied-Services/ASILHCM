...
// ─── Main SystemConfig ────────────────────────────────────────────────────────
const TABS = ['Employee Taxes', 'Vendor WHT Rates', 'Tax by Region', 'Statutory Reference', 'Employee Portal', 'Integrations', 'Report Distribution'];
...
export default function SystemConfig({ user }) {
    ...
    useEffect(() => {
        ...
        ]).then(([iTaxRes, vWHTRes, statRes, regRes, portalRes]) => {

...
const ROLE_META = {
  ...
  monthly_cycle:         { label: 'Monthly Cycle',         color: '#0d9488', bg: 'rgba(13,148,136,0.12)', desc: 'Collect attendance and claims only. No payroll lock, invoices, or AP.' },
...
const MODULES = [
  ...
  {
    key: 'fixed_value', label: 'Fixed Value / PSO (hidden)', navKey: 'fixed_value',
    icon: <MapPin size={16} />,
    subPerms: ['view', 'edit'],
  },
  {
    key: 'month_invoices', label: 'Month Invoices', navKey: 'month_invoices',
    icon: <FileText size={16} />,
    subPerms: ['view', 'edit'],
  },
  {
    key: 'monthly_cycle', label: 'Monthly Cycle', navKey: 'monthly_cycle',
...
const ROLE_NAV_SET = {
  superadmin:            ['dashboard','employee','payroll','fixed_value','month_invoices','documents','billing','invoices','po_tracking','ap','client','vendor','inventory','annexure','config','users','attendance','maintenance','claims_portal','monthly_cycle'],
  operations:            ['employee','documents','client','fixed_value','month_invoices','attendance','maintenance','claims_portal','monthly_cycle'],
  operations_supervisor: ['employee','documents','client','fixed_value','month_invoices','attendance','maintenance','claims_portal','monthly_cycle'],
  operations_team:       ['employee','documents','client','fixed_value','month_invoices','attendance','maintenance','claims_portal','monthly_cycle'],
  ...
  finance_proposer:      ['billing','invoices','fixed_value','month_invoices','po_tracking','employee','ap','vendor','inventory','annexure','maintenance'],
  finance_approver:      ['payroll','billing','invoices','fixed_value','month_invoices','po_tracking','client','annexure','config','users','attendance','claims_portal','monthly_cycle'],
  finance_manager:       ['payroll','billing','invoices','fixed_value','month_invoices','po_tracking','ap','client','vendor','annexure','config','users','attendance','maintenance','claims_portal','monthly_cycle'],
  ap_team:               ['ap','billing','fixed_value','month_invoices'],
  ar_team:               ['invoices','fixed_value','month_invoices','po_tracking','billing'],
  payroll_initiator:     ['payroll','fixed_value','month_invoices','employee','claims_portal','monthly_cycle'],
  payroll:               ['payroll','fixed_value','month_invoices','employee','claims_portal','monthly_cycle'],
  bizdev:                ['client'],

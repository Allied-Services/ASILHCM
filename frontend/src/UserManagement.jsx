...
const ROLE_NAV_SET = {
  superadmin:            ['dashboard','employee','payroll','fixed_value','documents','billing','invoices','po_tracking','ap','client','vendor','inventory','annexure','config','users','attendance','maintenance','claims_portal','monthly_cycle'],
  ...
  finance_approver:      ['payroll','billing','invoices','fixed_value','po_tracking','client','annexure','config','users','attendance','claims_portal','monthly_cycle'],
  finance_manager:       ['payroll','billing','invoices','fixed_value','po_tracking','ap','client','vendor','annexure','config','users','attendance','maintenance','claims_portal','monthly_cycle'],
  ap_team:               ['ap','billing','fixed_value'],
  ar_team:               ['invoices','fixed_value','po_tracking','billing'],
  payroll_initiator:     ['payroll','fixed_value','employee','claims_portal','monthly_cycle'],
  payroll:               ['payroll','fixed_value','employee','claims_portal','monthly_cycle'],
  bizdev:                ['client'],

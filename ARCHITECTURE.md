...
| Contract / SO line edit roles | Create/Edit wizard (incl. SO Lines): `superadmin`, `operations`, **`finance_manager`**. User Management `fixed_value` **edit** also shows the wizard. Seed re-sync stays superadmin-only. |

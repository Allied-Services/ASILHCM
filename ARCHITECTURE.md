...
| Engine flag | `payroll_engine=legacy` (default): Sheet Calculate/lock/AP pay. `runs`: Sheet write/calculate `409 CONTRACT_ON_RUNS_ENGINE`; compute without flip `409 CONTRACT_ON_LEGACY_ENGINE`. Do not flip production without `Go red:`. |

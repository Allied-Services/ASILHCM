...
**EOBI (period-aware):** `taxEngine.calculateEOBI({ year, month })` is the single source. Through Jul 2026: EE Rs. 400 / ER Rs. 2,000. From Aug 2026: EE Rs. 430 / ER Rs. 2,150. Already-calculated months keep their `computed_json` snapshot until Calculate is re-run for that period.

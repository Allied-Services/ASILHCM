...
> Last updated: 2026-09-07 · Keep under ~100 lines. Plain English only.
...
STATUS: **AMBER** — Live email and SMS are **on** (Go red 3 Sep). August payslip resend still open. Pilot Excel export still blocked. Do not Calculate August. Live health 7 Sep: ok · commit `211dd8d`.
...
**Live email and SMS are on.** August payslip resend still open. Do not Calculate August. Morning email Automation still cannot send (no email tool connected).
...
11. **Morning brief Automation** — weekday runs fire; email delivery still not connected (PR + HTML card only)
...
- **Connect morning brief email** on the Automation (https://cursor.com/automations/5e5c7662-8dce-11f1-a7d1-d6b4613131ce) — digests stay email-only

...
> Last updated: 2026-09-16 · Keep under ~100 lines. Plain English only.
...
STATUS: **AMBER** — Live email and SMS are **on** (Go red 3 Sep). August payslip resend (304) still open. Do not Calculate August. Site health OK on 16 Sep (commit `6d23b89`).
...
**Live email and SMS are on.** August payslip resend (304) still open after the blocked send. Do not Calculate August. Morning brief email still not connected on the Automation.
...
11. **Morning brief Automation** — weekday runs on; email delivery still not connected (no send tool on the Automation)
...
- **Confirm August payslip resend** finished (or Go red for more live send)

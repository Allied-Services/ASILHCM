...
> Last updated: 2026-09-09 · Keep under ~100 lines. Plain English only.
...
STATUS: **AMBER** — Live email and SMS are **on** (Go red 3 Sep). August payslip resend still open. Do not Calculate August. Live health OK (commit `b381976`).
...
**Live email and SMS are on.** August payslip resend still open after the blocked send (0/304). Do not Calculate August. Morning brief Automation runs weekdays; inbox email still not connected.
...
11. **Morning brief Automation** — weekday cron on; email delivery still not connected (no send tool)
...
- **Connect morning-brief email** on the Automation so weekday briefs reach your inbox

...
> Last updated: 2026-09-08 · Keep under ~100 lines. Plain English only.
...
STATUS: **AMBER** — Live email and SMS are **on** (Go red 3 Sep). August payslip resend still open. Do not Calculate August. Site health OK on 8 Sep (commit `055f3c4`).
...
- **Connect morning-brief email** on the Automation so weekday digests reach the inbox

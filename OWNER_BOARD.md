...
> Last updated: 2026-09-25 · Keep under ~100 lines. Plain English only.
...
STATUS: **AMBER** — Live site OK (commit `585586c`). Live email and SMS are **on**. August payslip resend still open. Do not Calculate August. Morning email delivery still not connected on the Automation.
...
**Live site OK (`585586c`).** Live email and SMS are on. August payslip resend still open. Do not Calculate August. Morning Automation has no email send tool yet.
...
11. **Morning brief Automation** — weekday cron runs; email delivery still disconnected (no send tool)
...
- **PR #206** merge conflicts (EOBI/SESSI + cost-plus invoice stamp)
- Confirm **August payslip resend** done (or say when)
- Connect **morning Automation email** so briefs hit the inbox

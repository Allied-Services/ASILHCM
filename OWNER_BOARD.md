...
> Last updated: 2026-08-20 · Keep under ~100 lines. Plain English only.
...
STATUS: **AMBER** — Calculate OT wipe fix is on `main` (#48); July Unlock → Calculate live proof still open; pilot Excel vs HCM shadow month still blocked on payroll export.  
LIVE: prod API healthy (`3c370d4`); old pay path still pays. Prefer staging Unlock → Calculate proof before relying on July nets in prod.
...
**Mission gate still open:** prove one pilot month (Excel vs HCM zero gap, then pay through the new path). Calculate no longer wipes sheet OT when hub OT=0 (#48 on main). Remaining Excel net gap (~bonus/tax) is separate. Portal Claims chase desk is live (#101). FV month close / letterhead shipped (#104, #105).
...
11. **Morning brief Automation** — weekday cron runs; **email delivery still not connected** (PR-only until you connect inbox)
...
## IN PROGRESS
- July Unlock → Calculate live proof (staging, then prod nets) — still open
- BPO / PSO contract matching on staging (separate track — do not block)

## JUST SHIPPED
- **FV month close + AP payables** (2026-08-20 live) — invoice finalization path on `main` (`3c370d4`, #105)
- **FV invoice letterhead margins** (2026-08-19) — print margins / footer trim (#104)
- **Portal Claims Response chase desk** (2026-08-17) — who acts next; invite/remind from the list (#101)
- **Payroll Sheet Calculate preserves sheet OT** (2026-08-11) — hub OT=0 no longer wipes OT2/OT3 (#48)
- **FV PSO July payroll headcount** (2026-08-02) — live run #117 = **185 HC**, Model A wages verified, net **8,090,438** (`e0af43e`)
...
- **Connect morning email** on the Automation so weekday briefs land in your inbox (no SMS)
...
- Portal Claims chase desk (who acts next + remind)
...
- Connect weekday morning email so briefs land in inbox (PR is not enough)

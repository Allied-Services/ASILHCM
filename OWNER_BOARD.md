...
11. **Morning brief Automation** — weekday runs are on; email delivery still not connected (brief lands in PR / Cursor only)
...
- **Close PR #146** — EOBI already live via #151; this PR is conflicting and leftover
- **Review PR #158** — locked payroll AP sync; conflicts + needs human review

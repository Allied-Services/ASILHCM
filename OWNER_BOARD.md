...
> Last updated: 2026-08-24 · Keep under ~100 lines. Plain English only.
...
STATUS: **AMBER** — Calculate OT wipe fix shipped (#48); July Unlock → Calculate live proof still open; pilot Excel export still blocked.  
LIVE: prod API healthy (`3c370d4`); FV month close #105 + letterhead #104 on main.
...
**Pilot proof still open.** Calculate no longer wipes sheet OT (#48 on main). Next: Unlock → Calculate July on staging then prod and check nets; still need payroll Excel export for S5B shadow month. No open work PR needs a yes today. Morning email still not connected on the Automation.
...
11. **Morning brief Automation** — weekday runs on; **email delivery still not connected** (brief lands in PR only)
...
## JUST SHIPPED (recent)
- **FV month close + letterhead** — #105 / #104 on main (`3c370d4`)
- **Portal Claims Response chase desk** — #101 on main
- **Calculate OT preserve** — #48 on main (hub zeros no longer wipe sheet OT)
- **FV PSO July payroll headcount** (2026-08-02) — live run #117 = **185 HC**, net **8,090,438**

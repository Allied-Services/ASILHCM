...
LIVE: prod API healthy (`/health` 200, status ok, migrations ok, commit `60b88f5`, verified 2026-08-10 04:02 UTC).
...
11. **Morning brief Automation** — weekday cron on; email delivery still not connected (brief lands in PR + `docs/owner/morning_latest.html`)

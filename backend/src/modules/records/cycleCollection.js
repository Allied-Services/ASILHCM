...
/**
 * Derive Monthly Cycle collection from enabled claim types.
 * Setup no longer shows a Collection Mode dropdown.
 *
 * Attendance only        → machine file, absent_days only
 * Attendance + OT        → machine file, absent_days + ot2 + ot3
 * Expense and/or Medical → monthly_form (Wafi unchanged)
 * Attendance + claims    → mixed (portal for claims, absent-days file if Attendance is on)
 */
...
function deriveCycleCollection(enabledTypes) {
